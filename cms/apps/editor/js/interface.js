...
window.jo_labelset = [
  {
    ...
    features: [
      ["/cms/core/style/icons/plusgray.svg", jo_additem]
    ],
    init: function(e){
  ...
  },
  {
    ...
    features: [
      ["/cms/core/style/icons/drag.svg", "jo_handle"],
      ["/cms/core/style/icons/delete.svg", jo_delete]
    ],
    init: function(e){
...
$(document).ready(function(e){
    ...
    jo_actionwindow(cms_imageupload,function(){
      cms_content('cancel');
    });
...
function jo_tinymce_init(elem, mobile = false){
              ...
              onclick: function (){
                   jo_window({
                       ...
                       cb: function(opt, cb){
                           ...
                           jo_ajax('/cms/apps/mask/inc/getmask.php', message, function(e,data,url){
                               var mask_list = {};
  ...
  var jo_tinymce_settings = {
    ...
    statusbar: false,
    branding: false,
    fixed_toolbar_container:"#cms_buttons",
    ...
    images_upload_url: "/cms/apps/editor/inc/upload.php",
    file_picker_types: "image",
    ...
    file_picker_callback: function(callback, value, meta) {
        ...
        form.push({
            id: "url",
            cb: function(opt, cb){
              jo_ajax('/cms/apps/editor/inc/galery.php',"",function(e,data,url){
                  var url_list = {};
...
function jo_taskvalid(){
  ...
  jo_ajax('/cms/core/inc/taskvalid.php',content_complete,function(e,data,url){});
}

function cms_imageupload(){
    $("#cms_functions_submit_save").addClass("jo_load");
...
function cms_content(advice){
    ...
    if(advice != "save"){
        ...
        $("#cms_functions_submit_cancel").addClass("jo_load");
    }else{
    ...
    jo_ajax('/cms/apps/editor/inc/save.php',content_complete,function(e,data,url){
        clearInterval(window.jo_interval);
        window.location.replace("/cms/control/cms.php?path=" + encodeURIComponent(e.redirection));
    },false);
}
...
//removes all cms items from code
//input: html code
//return: cleaned code
