$(document).ready(function(e){
    ...
    $('<input id="jo_delete_check" type="checkbox"/><label for="jo_delete_check">'+jo_lang.AREA_DEL+'</label>').appendTo('#cms_buttons');
...
function cms_content(advice){
    ...
    content_complete.url = window.location.href;
    jo_ajax('/cms/apps/areaselector/inc/save.php',content_complete,function(e,data,url){
